...
## 🚀 Sobre mim
- 🎓 Cursando Tecnologia em Análise e Desenvolvimento de Sistemas (ADS) - SENAI FATESG.
- 💻 Atualmente aprofundando conhecimentos no ecossistema Java (Spring Boot).
- 🛠️ Desenvolvendo projetos práticos com arquitetura em camadas e boas práticas de engenharia de software.

## 🛠️ Tecnologias e Ferramentas
Aqui estão as principais tecnologias com as quais trabalho ou estou estudando ativamente:
